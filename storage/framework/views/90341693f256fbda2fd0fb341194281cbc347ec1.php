            ...
            <div class="ibox-content">
                 <div class="row">
                    ...
                    <div class=" col-md-2 float-right">
                        <a href="<?php echo e(route('admin.schedule_classes.add')); ?>"> <button type="button" class="btn  btn-primary">
                                <i class="fa fa-plus mr-2"></i>Schedule new class
                            </button></a>
                    </div>
      ...
      <div class="modal-content">
        ...
        <form id="deleteModuleSubmit">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="scheduleClass" id="video-id" required>
                <?php echo csrf_field(); ?>
              </div>
...
$('.video-table').DataTable({
                ...
                "serverSide": true,
                    "ajax": {
                        url: "<?php echo e(route('admin.schedule_classes.list')); ?>",
        ...
        $('#deleteModuleSubmit').on('submit', function(e){
            ...
            $.ajax({
                    url: "<?php echo e(route('admin.deleteScheduleClass')); ?>",
                    type: 'POST',
                    dataType: 'json',
                    data: fd,
                    contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/e42hkfu2q4wn/public_html/dev.auricle.co.in/resources/views/admin/schedule_classes/list.blade.php ENDPATH**/ ?>