            ...
            <div class="ibox-content">
                <div class="row">
                    ...
                    <div class=" col-md-2 float-right">
                        <a href="<?php echo e(route('admin.media.news.add')); ?>"> <button type="button" class="btn  btn-primary">
                                <i class="fa fa-plus mr-2"></i>Add Media News
                            </button></a>
                    </div>
...
<script>
    ...
    $(document).ready(function(){
            $('.news-list').DataTable({
                ...
                "serverSide": true,
                    "ajax": {
                        url: "<?php echo e(route('admin.media.news.list')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/e42hkfu2q4wn/public_html/dev.auricle.co.in/resources/views/admin/media-news/index.blade.php ENDPATH**/ ?>