            ...
            <div class="ibox-content">
                <div class="row">
                    ...
                    <div class=" col-md-2 float-right">
                        <a href="<?php echo e(route('admin.plans.add')); ?>"> <button type="button" class="btn  btn-primary">
...
<script>
    ...
    $(document).ready(function(){
            $('.plan-list').DataTable({
                ...
                "serverSide": true,
                    "ajax": {
                        url: "<?php echo e(route('admin.plans.list')); ?>",
    ...
    //Show Delete Modal on Click
        ...
        $('#deleteSubmit').on('submit', function(e){
            ...
            $.ajax({
                    url: "<?php echo e(route('admin.delete.plan')); ?>",
                    type: 'POST',
                    dataType: 'json',
                    data: fd,
                    contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/e42hkfu2q4wn/public_html/dev.auricle.co.in/resources/views/admin/plan-subscriptions/plan_list.blade.php ENDPATH**/ ?>