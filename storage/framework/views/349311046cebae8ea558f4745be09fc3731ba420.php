    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins anskey">
            <div class="ibox-title">
               <h3><a href="<?php echo e(route('admin.plans.list.view')); ?>">Plan Subscription List </a>/ Add Plan Subscription </h3> 
            </div>
            <div class="ibox">
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#plan-submit').on('submit', function(e){
            ...
            $.ajax({
                    url: "<?php echo e(route('admin.plans.create')); ?>",
                    type: 'POST',
                    dataType: 'json',
                    data: fd,
                    contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/e42hkfu2q4wn/public_html/dev.auricle.co.in/resources/views/admin/plan-subscriptions/add.blade.php ENDPATH**/ ?>