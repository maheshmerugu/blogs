...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <b><label for="">Views</label></b>
                                <div class=" form-group">
                                   
                                    <input type="number" name="views" value="<?php echo e($news->views); ?>" class="form-control" required>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/e42hkfu2q4wn/public_html/dev.auricle.co.in/resources/views/admin/app-news/edit.blade.php ENDPATH**/ ?>