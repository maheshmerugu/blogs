...
<script>
    ...
    $('#blog-list').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "<?php echo e(route('admin.blogs.list')); ?>",
        ...
        'columns': [
            ...
            },
            {
                ...
                'render': function (data, type, row) {
                    return data.map(image => '<img src="' + image.image_path + '" alt="Image" class="img-thumbnail" width="50">').join(' ');
                },
                'searchable': false,
                'orderable': true
            },
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blogs\resources\views/admin/blogs/list.blade.php ENDPATH**/ ?>