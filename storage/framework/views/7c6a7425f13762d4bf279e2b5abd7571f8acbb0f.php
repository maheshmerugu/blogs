            ...
            <div class="ibox-content">
                <div class="row">
                    ...
                    <div class=" col-md-2 float-right">
                        <a href="<?php echo e(route('admin.cms.add')); ?>"> <button type="button" class="btn  btn-primary">
                                <i class="fa fa-plus mr-2"></i>Add CMS
                            </button></a>
                    </div>
      ...
      <div class="modal-content">
        ...
        <form id="deleteSubmit">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="cms" id="cms-id" required>
                <?php echo csrf_field(); ?>
              </div>
...
<script>
    ...
    $(document).ready(function(){
            $('.news-list').DataTable({
                ...
                "serverSide": true,
                    "ajax": {
                        url: "<?php echo e(route('admin.cms.list')); ?>",
        ...
        $('body').on('click', '.deleteCms', function(){

            $('#cms-id').val($(this).attr('data-id'))
        ...
        $('#deleteSubmit').on('submit', function(e){
            ...
            $.ajax({
                    url: "<?php echo e(route('admin.delete.cms')); ?>",
                    type: 'POST',
                    dataType: 'json',
                    data: fd,
                    contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/e42hkfu2q4wn/public_html/dev.auricle.co.in/resources/views/admin/content-management/cms_list.blade.php ENDPATH**/ ?>