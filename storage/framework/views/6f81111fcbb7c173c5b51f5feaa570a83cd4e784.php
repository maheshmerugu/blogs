 ...
 <!-- Toastr -->
 <script src="<?php echo e(asset('admin')); ?>/js/plugins/toastr/toastr.min.js"></script>
 <script src="<?php echo e(asset('admin')); ?>/js/plugins/validate/jquery.validate.min.js"></script>
 <!-- Data picker -->
 <script src="<?php echo e(asset('admin')); ?>/js/plugins/datapicker/bootstrap-datepicker.js"></script>
 <script src="<?php echo e(asset('admin')); ?>/js/plugins/sweetalert/sweetalert.min.js"></script>
 <script src="<?php echo e(asset('admin')); ?>/js/plugins/switchery/switchery.js"></script>
 ...
 </script><?php /**PATH /home/e42hkfu2q4wn/public_html/dev.auricle.co.in/resources/views/admin/layouts/partials/js.blade.php ENDPATH**/ ?>