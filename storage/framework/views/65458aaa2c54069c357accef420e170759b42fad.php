            ...
            <div class="ibox-content">
                <div class="row">
                    ...
                    <div class=" col-md-2 float-right">
                        <a href="<?php echo e(route('admin.faq.add')); ?>"> <button type="button" class="btn  btn-primary">
                ...
                <div class="table-responsive mt-5">
                    <table class="table table-striped faq-list">
                        <thead>
                            <tr>
                                <th>Sr.No </th>
                                <th>Question </th>
      ...
      <div class="modal-content">
        ...
        <form id="deleteSubmit">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="faq" id="faq-id" required>
                <?php echo csrf_field(); ?>
              </div>
...
<script>
    ...
    $(document).ready(function(){
            $('.faq-list').DataTable({
                ...
                "serverSide": true,
                    "ajax": {
                        url: "<?php echo e(route('admin.faq.list')); ?>",
                    ...
                    'columnDefs': [
                        ...
                        {"targets": 1, "name": "question", 'searchable': true, 'orderable': true},
                       
                        {"targets": 2, "name": "answer", 'searchable': false, 'orderable': true},
        ...
        $('#deleteSubmit').on('submit', function(e){
            ...
            $.ajax({
                    url: "<?php echo e(route('admin.delete.faq')); ?>",
                    type: 'POST',
                    dataType: 'json',
                    data: fd,
                    contentType: false,
                    ...
                    success: function (data) {
                        ...
                        if(data.status){
                            ...
                            $('.faq-list').DataTable().ajax.reload(null, false);
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/e42hkfu2q4wn/public_html/dev.auricle.co.in/resources/views/admin/faq/faq_list.blade.php ENDPATH**/ ?>