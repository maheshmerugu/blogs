    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins anskey">
           <div class="ibox-title">
               <h3><a href="<?php echo e(route('admin.cms.list.view')); ?>"> FAQ management </a>/ Update Faq</h3> 
            </div>
            <div class="ibox">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="question" class="form-control" value="<?php echo e($faq->question); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="answer" class="summernote" id="answer" rows="10"><?php echo e($faq->answer); ?></textarea>
                                </div>
                            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#faq-submit').on('submit', function(e){
            ...
            $.ajax({
                    url: "<?php echo e(route('admin.faq.update')); ?>",
                    type: 'POST',
                    dataType: 'json',
                    data: fd,
                    contentType: false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/e42hkfu2q4wn/public_html/dev.auricle.co.in/resources/views/admin/faq/edit.blade.php ENDPATH**/ ?>