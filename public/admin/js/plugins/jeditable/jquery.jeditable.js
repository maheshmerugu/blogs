...
(
    function ($) {
        $.fn.editable = function (target, options) {
            ...
            var submit =
                $.editable.types[settings.type].submit || function () {};
            var buttons =
                ...
                $(this).bind(settings.event, function (e) {
                    ...
                    if (0 == $(self).width()) {
                        ...
                        if (settings.width != "none") {
                            settings.width = settings.autowidth
                                ? $(self).width()
                                : settings.width;
                        }
                        if (settings.height != "none") {
                            settings.height = settings.autoheight
                                ? $(self).height()
                                : settings.height;
                        }
                    }
                    ...
                    if (
                        $(this).html().toLowerCase().replace(/(;|")/g, "") ==
                    ...
                    form.submit(function (e) {
                        ...
                        if (false !== onsubmit.apply(form, [settings, self])) {
                            ...
                            /* if it returns false abort submitting */
                            if (
                                false !== submit.apply(form, [settings, self])
                            ) {
                                /* check if given target is function */
                                if ($.isFunction(settings.target)) {
                                    var str = settings.target.apply(self, [
                                        input.val(),
                                        settings,
                                    ]);
                                    $(self).html(str);
                    ...
                    buttons: function (settings, original) {
                        ...
                        if (settings.submit) {
                            ...
                            if (settings.submit.match(/>$/)) {
                                var submit = $(settings.submit).click(
                                    function () {
